...
const $$splitComponentImporter$5 = () => import('./start.server-funcs-B2zYaptC.mjs');
...
const $$splitComponentImporter$2 = () => import('./start.ssr.spa-mode-BYDg9wK3.mjs');
...
const $$splitComponentImporter$1 = () => import('./start.ssr.full-ssr-qR2O6b85.mjs');
const Route$1 = createFileRoute("/demo/start/ssr/full-ssr")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  loader: async () => await getPunkSongs()
});
const $$splitComponentImporter = () => import('./start.ssr.data-only-BzOQWewh.mjs');
