...
import { a as Route$1 } from './router-BuwUbdwe.mjs';
...
function RouteComponent() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center min-h-screen bg-gradient-to-br from-zinc-800 to-black p-4 text-white", style: {
    ...
    /* @__PURE__ */ jsx("h1", { className: "text-3xl font-bold mb-6 text-blue-400", children: "Full SSR - Punk Songs" }),
...
//# sourceMappingURL=start.ssr.full-ssr-D_HlkAjW.mjs.map
