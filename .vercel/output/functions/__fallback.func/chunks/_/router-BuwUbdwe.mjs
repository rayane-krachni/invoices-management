...
const appCss = "/assets/styles-CfZC-irW.css";
const Route$9 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        title: "Snc krachni et fr\xE8res"
      }
    ],
    links: [
      {
...
const $$splitComponentImporter$7 = () => import('./dashboard-orSO09dN.mjs');
...
const $$splitComponentImporter$5 = () => import('./start.server-funcs-DVtXsPy9.mjs');
...
const $$splitComponentImporter$3 = () => import('./start.ssr.index-DW0C9PHQ.mjs');
const Route$3 = createFileRoute("/demo/start/ssr/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./start.ssr.spa-mode-C3S2Ve4T.mjs');
...
const $$splitComponentImporter$1 = () => import('./start.ssr.full-ssr-D_HlkAjW.mjs');
const Route$1 = createFileRoute("/demo/start/ssr/full-ssr")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  loader: async () => await getPunkSongs()
});
const $$splitComponentImporter = () => import('./start.ssr.data-only-B-mhF_Xr.mjs');
...
export { Route$6 as R, Route$1 as a, Route as b, getPunkSongs as g, router as r };
//# sourceMappingURL=router-BuwUbdwe.mjs.map
