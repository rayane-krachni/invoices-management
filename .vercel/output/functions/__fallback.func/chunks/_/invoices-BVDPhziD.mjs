...
import { pgTable, timestamp, varchar, uuid, uniqueIndex, boolean, numeric, text, integer } from 'drizzle-orm/pg-core';
import { z } from 'zod';
...
const products = pgTable(
  ...
  (table) => [uniqueIndex("product_code_idx").on(table.code)]
);
...
const fournisseurs = pgTable("fournisseurs", {
  id: uuid("id").defaultRandom().primaryKey(),
...
//# sourceMappingURL=invoices-BVDPhziD.mjs.map
