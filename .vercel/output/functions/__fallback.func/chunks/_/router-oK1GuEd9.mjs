...
const $$splitComponentImporter$7 = () => import('./dashboard-BeqN3vqU.mjs');
...
const $$splitComponentImporter$5 = () => import('./start.server-funcs-BspxAqgy.mjs');
...
const $$splitComponentImporter$2 = () => import('./start.ssr.spa-mode-cHC_E7lE.mjs');
...
const $$splitComponentImporter$1 = () => import('./start.ssr.full-ssr-DNwPqA7h.mjs');
const Route$1 = createFileRoute("/demo/start/ssr/full-ssr")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  loader: async () => await getPunkSongs()
});
const $$splitComponentImporter = () => import('./start.ssr.data-only-BMnaEupE.mjs');
...
//# sourceMappingURL=router-oK1GuEd9.mjs.map
