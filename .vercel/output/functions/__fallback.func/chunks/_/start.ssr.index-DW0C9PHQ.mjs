...
function RouteComponent() {
  return /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center min-h-screen bg-gradient-to-br from-zinc-900 to-black p-4 text-white", style: {
    ...
    /* @__PURE__ */ jsx("h1", { className: "text-4xl font-bold mb-8 text-center bg-gradient-to-r from-pink-500 via-blue-500 to-green-400 bg-clip-text text-transparent", children: "SSR Demos" }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/demo/start/ssr/full-ssr", className: "text-2xl font-bold py-6 px-8 rounded-lg bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white text-center shadow-lg transform transition-all hover:scale-105 hover:shadow-blue-500/50 border-2 border-blue-400", children: "Full SSR" }),
...
//# sourceMappingURL=start.ssr.index-DW0C9PHQ.mjs.map
