...
const $$splitComponentImporter$7 = () => import('./dashboard-CB_39-Y5.mjs');
...
const $$splitComponentImporter$5 = () => import('./start.server-funcs-DtxLBD8-.mjs');
...
const $$splitComponentImporter$2 = () => import('./start.ssr.spa-mode-DMuj2r7e.mjs');
...
const $$splitComponentImporter$1 = () => import('./start.ssr.full-ssr-DsKo2gcs.mjs');
const Route$1 = createFileRoute("/demo/start/ssr/full-ssr")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component"),
  loader: async () => await getPunkSongs()
});
const $$splitComponentImporter = () => import('./start.ssr.data-only-DMKwoIKF.mjs');
...
//# sourceMappingURL=router-Ba7CDJIz.mjs.map
